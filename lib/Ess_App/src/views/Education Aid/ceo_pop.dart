...
class CeoPopupDialog extends StatefulWidget {
  final List<dynamic> datalist;

  final String name;
  final String fnf_id;
  final String title;
  CeoPopupDialog({Key? key, required this.name , required this.title, required this.fnf_id, required this.datalist}) : super(key: key);

  @override
  State<CeoPopupDialog> createState() => _ProfessionalPopupDialogState();
}

class _ProfessionalPopupDialogState extends State<CeoPopupDialog> {
