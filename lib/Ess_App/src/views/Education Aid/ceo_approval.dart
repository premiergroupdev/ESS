...
class CeoAidDataScreen extends StatefulWidget {
  const CeoAidDataScreen({super.key});

  @override
  State<CeoAidDataScreen> createState() => _AidDataScreenState();
}

class _AidDataScreenState extends State<CeoAidDataScreen> {
  ...
  Future<void> fetchAidData() async {
    final url = Uri.parse(
        'https://premierspulse.com/ess/scripts/fetch_my_aid.php?EMPCODE=${currentUser?.userId.toString()}&api_type=hodlevel');
    final headers = {
                                  ...
                                  onTap: () async {
                                    ...
                                    bool? shouldRemove = await   showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return  HrPopupDialog( title: 'hr_level2', fnf_id: item['aid_id'], datalist: aidDataList, name: item['employee_name'],
