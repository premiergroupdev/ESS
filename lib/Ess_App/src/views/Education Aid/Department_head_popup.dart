...
class DepartmentPopupDialog extends StatefulWidget {
  final List<dynamic> datalist;

  final String name;
  final String fnf_id;
  final String title;
  DepartmentPopupDialog({Key? key, required this.name , required this.title, required this.fnf_id, required this.datalist}) : super(key: key);

  @override
  State<DepartmentPopupDialog> createState() => _ProfessionalPopupDialogState();
}

class _ProfessionalPopupDialogState extends State<DepartmentPopupDialog> {
  ...
  Future<void> Apicall2() async {
    ...
    final url = Uri.parse(
      'https://premierspulse.com/ess/scripts/update_education_aid_status.php'
          ...
          '&approval_percentage=${hodcode_controller.text}'
      ,
    );
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Comments TextBox
                      Text(
                        'Approval Percentage ${widget.datalist[0]['approved_percentage'].toString()} %',
                        style: TextStyle(
                          fontSize: 16,
                      ...
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: const InputDecoration(
                            ...
                            hintText: 'Enter percentage here...',
