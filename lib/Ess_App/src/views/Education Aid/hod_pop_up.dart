...
class HodPopupDialog extends StatefulWidget {
  final List<dynamic> datalist;

  final String name;
  final String fnf_id;
  final String title;
  HodPopupDialog({Key? key, required this.name , required this.title, required this.fnf_id, required this.datalist}) : super(key: key);

  @override
  State<HodPopupDialog> createState() => _ProfessionalPopupDialogState();
}

class _ProfessionalPopupDialogState extends State<HodPopupDialog> {
