...
class AidDataScreen extends StatefulWidget {
  const AidDataScreen({super.key});

  @override
  State<AidDataScreen> createState() => _AidDataScreenState();
}

class _AidDataScreenState extends State<AidDataScreen> {
  ...
  Future<void> fetchAidData() async {
    final url = Uri.parse(
        'https://premierspulse.com/ess/scripts/fetch_my_aid.php?EMPCODE=${currentUser?.userId.toString()}&api_type=myrequest');
    final headers = {
