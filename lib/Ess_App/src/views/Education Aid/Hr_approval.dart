...
class HrAidDataScreen extends StatefulWidget {
  const HrAidDataScreen({super.key});

  @override
  State<HrAidDataScreen> createState() => _AidDataScreenState();
}

class _AidDataScreenState extends State<HrAidDataScreen> {
  ...
  Future<void> fetchAidData() async {
    final url = Uri.parse(
        'https://premierspulse.com/ess/scripts/fetch_my_aid.php?EMPCODE=${currentUser?.userId.toString()}&api_type=hrlevel');
    final headers = {
