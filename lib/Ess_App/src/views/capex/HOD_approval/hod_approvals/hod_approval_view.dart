...
import '../hod_approval_detail/hod_approval_detail_view.dart';
import 'hod_approval_view_model.dart';



class HOD_Capex_approval extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
      ...
      ViewModelBuilder<Hod_Capex_approval_viewmodel>.reactive(
          builder: (viewModelContext, model, child) => Scaffold(
            body:
            Column(
              children: [
                SizedBox(height: 10,),
                GeneralAppBar(title: "HOD Approval", onMenuTap: (){}, onNotificationTap: (){}),
                                  ...
                                  InkWell(
                                    onTap: (){
                                      ...
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => HodExpenseDetailScreen(name: item.memberName.toString(), copex_id:item.copexId.toString(), ),
                                        ),
                                      );
                                    },
                                    child: Chip(
          ...
          viewModelBuilder: () => Hod_Capex_approval_viewmodel(),
