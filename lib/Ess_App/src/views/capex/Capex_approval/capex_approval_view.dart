...
import 'capex_approval_view_model.dart';
import 'Capex_details/capex_details.dart';

class Capex_approval extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
      ...
      ViewModelBuilder<Capex_approval_viewmodel>.reactive(
        builder: (viewModelContext, model, child) => Scaffold(
      body:
      Column(
        children: [
          SizedBox(height: 10,),
          GeneralAppBar(title: "Final Capex Approval", onMenuTap: (){}, onNotificationTap: (){}),
                            ...
                            InkWell(
                              onTap: (){
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ExpenseDetailScreen(name: item.memberName.toString(), copex_id:item.copexId.toString(), ),
                                  ),
                                );
                              },
                              child: Chip(
    ...
    viewModelBuilder: () => Capex_approval_viewmodel(),
