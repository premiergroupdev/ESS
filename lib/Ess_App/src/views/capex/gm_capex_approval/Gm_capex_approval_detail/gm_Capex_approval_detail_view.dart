...
import 'gm_capex_approval_detail_view_model.dart';

class GMExpenseDetailScreen extends StatefulWidget {
  final String name;
  final String copex_id;
  GMExpenseDetailScreen({super.key,required this.name,required this.copex_id});

  @override
  State<GMExpenseDetailScreen> createState() => _ExpenseDetailScreenState();
}




class _ExpenseDetailScreenState extends State<GMExpenseDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return
      ...
      ViewModelBuilder<Gm_Capex_detail_view_viewmodel>.reactive(
                          ...
                          child: Container(
                            ...
                            child: DropdownButton<String>(
                              ...
                              onChanged: (value) async
                              {
                                ...
                                final response = await api.update_gm_copex_status(
                                  newValue,
...
print(response);
          ...
          viewModelBuilder: () => Gm_Capex_detail_view_viewmodel(),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            .format(int.tryParse(price) ?? 0)} | Qty: $qty",
              style: TextStyle(
                color: isSelected ? Colors.white : Colors.black,
