...
import '../../Capex_approval/capex_approval_view_model.dart';
import '../Gm_capex_approval_detail/gm_Capex_approval_detail_view.dart';
import 'gm_capex_approval_view_model.dart';


class Gm_Capex_approval extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
      ...
      ViewModelBuilder<Gm_Capex_approval_viewmodel>.reactive(
          builder: (viewModelContext, model, child) => Scaffold(
            body:
            Column(
              children: [
                SizedBox(height: 10,),
                GeneralAppBar(title: "Gm Capex Approval", onMenuTap: (){}, onNotificationTap: (){}),
                //  GeneAppBar(title: "Capex Approval"),
                (model.isBusy == true)
                                  ...
                                  InkWell(
                                    onTap: (){
                                      ...
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => GMExpenseDetailScreen(name: item.memberName.toString(), copex_id:item.copexId.toString(), ),
                                        ),
                                      );
                                    },
                                    child: Chip(
          ...
          viewModelBuilder: () => Gm_Capex_approval_viewmodel(),
