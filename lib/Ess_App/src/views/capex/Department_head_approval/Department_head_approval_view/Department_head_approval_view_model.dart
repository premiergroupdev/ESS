...
class Department_head_approval_viewmodel extends ReactiveViewModel  with AuthViewModel, ApiViewModel
{
  ...
  getgoal(BuildContext context,) async {
    try {
      var newsResponse = await runBusyFuture(
          apiService.head_of_department_capex(context));
      newsResponse.when(success: (data) async {
        if(data.copexApprovals!.length > 0) {
          ...
          Constants.customWarningSnack(context, "No Capex Found");
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Divider(),
              // _buildStatusRow("General Manager", gmStatus),
              SizedBox(height: 20),
              Align(
