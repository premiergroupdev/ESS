import 'package:ess/Ess_App/src/views/Resignation_form/pop_up.dart';
...
import 'Hr_one_view_model.dart';

class HrOneView extends StatefulWidget {


  @override
  State<HrOneView> createState() => _HodApprovalViewState();
}

class _HodApprovalViewState extends State<HrOneView> {
  ...
  Widget build(BuildContext context) {
    return
      ViewModelBuilder<HrOneViewModel>.reactive(
                        ...
                        return Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
Text("# ${item['fnf_id']}" , style: TextStyle(color: Colors.black),),
                                SizedBox(height: 10,),
                                Row(
                                  ...
                                  Row(
                                   ...
                                   InkWell(
                                     onTap: () async {
                                       ...
                                       //     return  ProfessionalPopupDialog( hodlist: [], title: 'hr_level2', fnf_id: item['fnf_id'], datalist: model.datalist, name: item['emp_name'],
                                       //
                                       //     );
                                       //   },
                                       // );
                                       ...
                                       bool? shouldRemove = await    showDialog(
                                         ...
                                         builder: (BuildContext context) {
                                           return
                                             ProfessionalPopupDialog( hodlist: [], title: 'hr_level1', fnf_id: item['fnf_id'], datalist: model.datalist,  name: item['emp_name']);
                                         },
                                       );
                                     ...
                                     child: Container(
                                       ...
                                       child: Text("Submit Approval", style: TextStyle(color: Colors.white),),
                                      ...
                                      //     onTap:(){
                                      //
                                      //       Navigator.push(context, MaterialPageRoute(builder: (context) =>  ProfessionalPopupDialog()));
                                      //     },
                                      //     child: Container(
                                      //
                                      //       child: Text("sad"),
        ...
        viewModelBuilder: () => HrOneViewModel(),
