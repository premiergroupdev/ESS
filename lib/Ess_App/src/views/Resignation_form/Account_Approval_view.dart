...
import 'Accounts_popup.dart';
import 'Hr_two_view_model.dart';
import 'IT_approval_popup.dart';
import 'IT_approval_view_model.dart';
import 'Line_manager_Approval_view_model.dart';
class AccountApprovalView extends StatefulWidget {


  @override
  State<AccountApprovalView> createState() => _HodApprovalViewState();
}

class _HodApprovalViewState extends State<AccountApprovalView> {
  @override
  Widget build(BuildContext context) {
    return
      ViewModelBuilder<ITApprovalViewModel>.reactive(
                        ...
                        return Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("# ${item['fnf_id']}",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black),),
                                        ...
                                        onTap: () async {
                                          ...
                                          bool? shouldRemove = await   showDialog(
                                            ...
                                            builder: (BuildContext context) {
                                              return  AccountsPopupDialog( hodlist: [], fnf_id: item['fnf_id'], datalist: model.datalist, name: item['emp_name'],
        ...
        viewModelBuilder: () => ITApprovalViewModel(),
