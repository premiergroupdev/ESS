...
class HrTwoView extends StatefulWidget {


  @override
  State<HrTwoView> createState() => _HodApprovalViewState();
}

class _HodApprovalViewState extends State<HrTwoView> {
  @override
  Widget build(BuildContext context) {
    return
      ViewModelBuilder<HrTwoViewModel>.reactive(
        ...
        viewModelBuilder: () => HrTwoViewModel(),
