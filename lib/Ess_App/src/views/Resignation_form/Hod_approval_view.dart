...
class HodApprovalView extends StatefulWidget {


  @override
  State<HodApprovalView> createState() => _HodApprovalViewState();
}

class _HodApprovalViewState extends State<HodApprovalView> {
  @override
  Widget build(BuildContext context) {
    return
      ViewModelBuilder<HodApprovalViewModel>.reactive(
      ...
      model.isBusy
        ...
        viewModelBuilder: () => HodApprovalViewModel(),
