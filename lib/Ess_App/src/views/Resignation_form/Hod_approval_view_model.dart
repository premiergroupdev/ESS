...
class HodApprovalViewModel extends ReactiveViewModel with AuthViewModel, ApiViewModel {
  ...
  Future<void> branchdata(BuildContext context) async {
    ...
    var response = await runBusyFuture(apiService.resignations_approval(context, empCode , "hod"));
    response.when(
      success: (data) {
