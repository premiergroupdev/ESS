...
class ItApprovalView extends StatefulWidget {


  @override
  State<ItApprovalView> createState() => _HodApprovalViewState();
}

class _HodApprovalViewState extends State<ItApprovalView> {
  @override
                                        ...
                                        onTap: () async {
                                          ...
                                          bool? shouldRemove = await   showDialog(
                                            ...
                                            builder: (BuildContext context) {
                                              return  ItApprovalPopup( hodlist: [], fnf_id: item['fnf_id'], datalist: model.datalist, name: item['emp_name'],
