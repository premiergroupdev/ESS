...
class HrTwoViewModel extends ReactiveViewModel with AuthViewModel, ApiViewModel {
  ...
  Future<void> branchdata(BuildContext context) async {
    ...
    var response = await runBusyFuture(apiService.resignations_approval(context, empCode, "hr_level2"));
    response.when(
      success: (data) {
