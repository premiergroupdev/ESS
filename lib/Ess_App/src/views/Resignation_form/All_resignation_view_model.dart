...
class AllResignationViewModel extends ReactiveViewModel with AuthViewModel, ApiViewModel {
  ...
  Future<void> branchdata(BuildContext context) async {
    var response = await runBusyFuture(apiService.Al_reservation(context));
    response.when(
      success: (data) {
